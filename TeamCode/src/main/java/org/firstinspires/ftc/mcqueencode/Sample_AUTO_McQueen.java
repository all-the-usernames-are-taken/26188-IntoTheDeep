...
public class Sample_AUTO_McQueen extends BaseOpMode {
...
//*************************************************************
		...
		tele("Whoops! You have to put the CD inside your computer.", 0);
/* Auto start
 Calibration tests!
...
// todo: non-blocking first, THEN functions
	...
	tele("[1]", 0);
	tele("driving diagonally", 2000);
	driveForwardDiagonalLeft(-20, 0.7);
	...
	tele("drive diagonally to sub", 2000);
	driveForwardDiagonalLeft(50, 0.7);
...
/*	
	...
	tele("[2] strafe to position", 2000);
	strafeLeft(-20, 0.7);
	driveForwardDiagonalRight(-8, 0.7);
	strafeLeft(-15, 0.7);
	
	tele("[3] push it in!!!", 2000);
	driveForward(-48);
	driveForward(48);
	strafeLeft(12);
	...
	tele("[4] hang it!", 2000);
	driveForwardDiagonalLeft(-40, 0.7);
	strafeLeft(-24, 0.7);
	driveForwardDiagonalLeft(-24, 0.4);
	tele("'hang' ;-; ", 500);
	driveForwardDiagonalLeft(48, 0.7);
	strafeLeft(24, 0.7);
*/	
	/*
